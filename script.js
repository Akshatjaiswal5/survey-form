function run()
{
 ...
 var data="{'name':'"+name+"','email':'"+email+"','number':'"+number+"','branch':'"+branch+"','batch':'"+batch+"','diplomaStudent':'"+diplomaStudent+"','hostelite':'"+hostelite+"','immigrant':'"+immigrant+"','feedback':'"+feedback+"',}";
